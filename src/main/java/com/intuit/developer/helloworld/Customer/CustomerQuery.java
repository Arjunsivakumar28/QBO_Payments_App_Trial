package com.intuit.developer.helloworld.Customer;
...
public class CustomerQuery {
    ...
    public String main(String[] args, HttpSession session) {
        try {
            return queryAllCustomers(session);
        } catch (Exception e) {
            return "! Error during Crud operation : " + e;
        }
    }
    
    public String queryAllCustomers(HttpSession session) throws FMSException, OAuthException {
