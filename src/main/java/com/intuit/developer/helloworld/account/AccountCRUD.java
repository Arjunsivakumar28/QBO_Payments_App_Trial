package com.intuit.developer.helloworld.account;
...
public class AccountCRUD {
    ...
    public String main(String[] args, HttpSession session) {
        try {
            return queryAllAccounts(session);
        } catch (Exception e) {
            return "! Error during Crud operation : " + e;
        }
    }
    
    public String queryAllAccounts(HttpSession session) throws FMSException, OAuthException {
