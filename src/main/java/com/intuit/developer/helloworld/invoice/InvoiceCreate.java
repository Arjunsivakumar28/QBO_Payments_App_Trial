...
public class InvoiceCreate {
	...
	public String createInvoice(HttpSession session) throws FMSException, ParseException {
		...
		try {
			...
			service.add(invoice);
			LOG.info("Invoice created: " + invoice.getId() + " ::invoice doc num: " + invoice.getDocNumber());
