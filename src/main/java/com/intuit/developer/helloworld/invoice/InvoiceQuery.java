...
public class InvoiceQuery {
	...
	public String queryInvoice(HttpSession session) throws FMSException, ParseException, OAuthException {
		...
		try {
			...
			// Testing the bearer token access token and refresh token values and expiry date
			...
			try {
				...
				LOG.error("Error while calling company currency :: " + e1.getMessage());
				return new JSONObject().put("response", failureMsg).toString();
